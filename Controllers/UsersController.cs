...
namespace FEFA_App.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            return View("Index", await _context.User.Where( j => j.FirstName.Contains(SearchPhrase) || j.LastName.Contains(SearchPhrase)).ToListAsync());
        }
